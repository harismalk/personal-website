    ...
    <div>
      <div className="p-6 bg-[var(--background)] transition-all">
        ...
        <p className="mb-4 font-body font-light lg:text-lg">
          I study computer science at <ExternalLink href="https://maps.app.goo.gl/pMwmPBY1LVvr2nbp9">Rutgers University</ExternalLink>. My primary focus lies in full-stack web development, but I'm increasingly fascinated by the infrastructure required to support large-scale AI/ML systems.
        </p>
        <p className="mb-4 font-body font-light lg:text-lg">
